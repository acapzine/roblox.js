...
export class user {
    ...
    async usernameHistory(): Promise<UsernameHistoryResponse[]> {
        const response = await fetch(`${USERS_API_URL}/${this.id}/username-history`, {
            method: "GET",
            headers: {
                'accept': 'application/json',
            },
    ...
    async userGroups_v1(): Promise<UserGroupsResponse_v1[]> {
        const response = await fetch(`${GROUPS_API_URL_v1_USERS}/${this.id}/groups/roles?includeLocked=true&includeNotificationPreferences=false`, {
            method: "GET",
            headers: {
                'accept': 'application/json',
            },
    ...
    async userGroups_v2(): Promise<UserGroupsResponse_v2[]> {
        const response = await fetch(`${GROUPS_API_URL_v2_USERS}/${this.id}/groups/roles?includeLocked=true&includeNotificationPreferences=false`, {
            method: "GET",
            headers: {
                'accept': 'application/json',
            },
...
export async function multiUserIDRequest(userids:Int32Array, excludeBanned?:boolean): Promise<POST_User_UserID> {
...
export async function multiUsernameRequest(usernames:Array<string>, excludeBanned?:boolean): Promise<POST_User_Username> {
    const response = await fetch(`${USERS_API_URL}`, {
        method: "POST",
        headers: {
            'accept': 'application/json',
...
export class group {
    ...
    async nameHistory(): Promise<GroupNameHistory[]> {
        const response = await fetch(`${GROUPS_API_URL_v1}/${this.id}/name-history`, {
            method: "GET",
            headers: {
                'accept':'application/json',
            },
    ...
    async usersInRoleset(rolesetid?:number): Promise<UsersInRoleset[]> {
        rolesetid ?? 255;
        const response = await fetch(`${GROUPS_API_URL_v1}/${this.id}/roles/${rolesetid}/users`, {
            method: "GET",
            headers: {
                'accept':'application/json',
            },
    ...
    async relationships(enemies?:boolean): Promise<GroupRelations[]> {
        enemies ?? false;
        if (enemies == false) {
            const response = await fetch(`${GROUPS_API_URL_v1}/${this.id}/relationships/allies?StartRowIndex=1&MaxRows=10`);
            const data = await response.json();
            return data.relatedGroups;
        } else {
            const response = await fetch(`${GROUPS_API_URL_v1}/${this.id}/relationships/enemies?StartRowIndex=1&MaxRows=10`);
            const data = await response.json();
            return data.relatedGroups;
        }
    }
    ...
    async guestRolePermissions(): Promise<GroupRolesPermissions[]> {
        const response = await fetch(`${GROUPS_API_URL_v1}/${this.id}/roles/guest/permissions`, {
            method: "GET",
            headers: {
                'accept': 'application/json',
            },
...
export class catalogInformation {
    ...
    async assetBundles(): Promise<AssetBundlesResponse[]> {
        const response = await fetch(`${CATALOG_API_URL_v1}/assets/${this.assetId}/bundles`, {
            method: "GET",
            headers: {
                'accept': 'application/json',
            },
    ...
    async userFavoriteAssetModelInfo(): Promise<UserFavoriteModelAssetInformationResponse[]> {
        const response = await fetch(`${CATALOG_API_URL_v1}/favorites/users/${this.userId}/assets/${this.assetId}/favorite`, {
            method: "GET",
            headers: {
                'accept': 'application/json',
            },
    ...
    async userFavoriteBundleInfo(): Promise<UserFavoriteBundleAssetInformationResponse[]> {
        const response = await fetch(`${CATALOG_API_URL_v1}/favorites/users/${this.userId}/bundles/${this.bundleId}/favorite`, {
            method: "GET",
            headers: {
                'accept': 'application/json',
            },
    ...
    async userFavoriteSubtypeInfo(): Promise<UserFavoriteSubtypeInformationResponse[]> {
        const response = await fetch(`${CATALOG_API_URL_v1}/favorites/users/${this.userId}/favorites/${this.subtypeId}/bundles`, {
            method: "GET",
            headers: {
                'accept': 'application/json',
            },
    ...
    async catalogItemDetails(itemsObject: { itemType: number, id: number }): Promise<ItemDetailsResponse> {
        const response = await fetch(`${CATALOG_API_URL_v1}/catalog/items/details`, {
            method: "POST",
            headers: {
                'accept': 'application/json',
            },
    ...
    async getTopics(itemsObject: { TargetId: number, ItemType: number }, topics: Array<string>, inputQuery: string, maxResults?:number): Promise<TopicsResponse> {
        maxResults ?? 1;
